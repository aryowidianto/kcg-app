...
@section('title', 'Master Mesin Finishing')

@section('content_header')
    <h1>Master Mesin Finishing</h1>
@endsection

@section('content')
    <a href="{{ route('mesin-finishing.create') }}" class="btn btn-primary mb-3">+ Tambah Mesin Finishing</a>
